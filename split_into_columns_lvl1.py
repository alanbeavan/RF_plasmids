...
def main():
    ...
    for line in oldlines:
        ...
        element_list = []
        if "US_marker_lvl1" in sequence and "DS_marker_lvl1" in sequence:
            for i in range(len(sequence)-1):
                if sequence[i] == "DS_marker_lvl1":
                    if sequence[i+1] == "US_marker_lvl1":
                        break
                    k = 8
                    j = 1
                    ...
                    break
                elif sequence[i] == "US_marker_lvl1":
                    if sequence[i+1] == "DS_marker_lvl1":
                        break
                    j = 1
                    k = 1
                    while len(element_list) < 8:
